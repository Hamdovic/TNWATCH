 ...
 */
public class MyTableModelResponsable extends AbstractTableModel {

    List<Responsable> listResponsable = new ArrayList<Responsable>();
    String []header = {"CIN","Nom","Prenom","email","domaine","grade"};

    public MyTableModelResponsable() { //remplissage de la liste des stocks
        listResponsable=new ResponsableDAO().DisplayAllResponsableNomConfir();
    }
